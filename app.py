...
st.title("Olympics Game Analysis")
st.sidebar.title("Olympics Analysis")
 
#My Linkedin Profile link
#if st.sidebar.button("Connect on LinkedIn"):
#   webbrowser.open_new_tab("https://www.linkedin.com/in/aditya-kumar-dubey-9833b4278/", "_blank")
...
if user_menu == 'Medal Tally':
    ...
    madel_tally =helper.fetch_medal_tally(df,selected_year,selected_country)
...
if user_menu == 'Country-wise Analysis':
    ...
    selected_country = st.sidebar.selectbox('Selsect Country ', country_list)

    country_df = helper.year_wise_tally(df,selected_country)
    fig = px.line(country_df, x='Year', y='Medal')
    st.title(selected_country + " Years wise Madel tally")
    st.plotly_chart(fig)
